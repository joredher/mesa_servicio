                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <div class="pull-right">
                            ...
                            <a type="button" id="resTicket" class="btn btn-primary btn-sm">Aceptar</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel-heading" style="background-color: rgba(48,151,209,0.5) !important;">
                    <h3 class="panel-title" style="display: flex !important;">
                        ...
                        <div style="padding-left: 0.8mm">
                            <a href="{{ url('/admin/tickets/export/xls')}}" data-toggle="tooltip" data-placement="top"
                                title="Exportar XLS" class="btn btn-primary">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <a href="{{ url('servicios_all') }}" data-toggle="tooltip" data-placement="top"
                                title="Recargar" class="btn btn-primary btn-md">
                        ...
                        {!! Form::button('<i class="fas fa-search"></i>',['type' => 'submit','class' => 'btn btn-info
                        btn-md']) !!}
                        {!! Form::close() !!}
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td class="row">
                                <div class="{{($ticket->etat !== 'Terminado')
                                    ...
                                    <a href="{{ url('servicio/'.$ticket->id.'/ver')}}" data-toggle="tooltip"
                                        data-placement="top" title="Ver Respuesta/s" class="btn btn-primary btn-sm">
                                ...
                                <div class="{{(is_null($ticket->fecha_consulta)
                                    ...
                                    <a href="{{ url('servicio/'.$ticket->id.'/consulter')}}" data-toggle="tooltip"
                                        data-placement="top" title="Responder" class="btn btn-success btn-sm">
                                ...
                                <div class="{{(is_null($ticket->fecha_consulta)
                                                            ? 'col-sm-6' : 'col-sm-4')}} text-center">
                                    <a data-toggle="modal" data-placement="top" data-target="#myConsult"
                                        onclick="myConsult([{{Auth::user()}}, {{$ticket}}])" title="Responder"
                                        id="modalUno" class="btn btn-success btn-sm">
                                        <i class="fas fa-file-alt"></i>
                                    </a>
                                </div>
                                @endif
                                ...
                                <div class="col-sm-6 text-center">
                                    <a href="{{ url('servicio/'.$ticket->id.'/consuasignar')}}" data-toggle="tooltip"
                                        data-placement="top" title="{{"Asignar Servicio #$ticket->id"}}"
                                ...
                                <div class="col-sm-4 text-center">
                                    <a href="{{ url('servicio/'.$ticket->id.'/terminado')}}" data-toggle="tooltip"
                                        data-placement="top" title="{{"Finalizar Servicio #$ticket->id"}}"
                                        class="btn btn-warning btn-sm">
