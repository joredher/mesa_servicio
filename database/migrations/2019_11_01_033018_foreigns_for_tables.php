...
class ForeignsForTables extends Migration
{
    ...
    public function up()
    {
        DB::statement("ALTER TABLE `tickets` 
                    ...
                    ADD INDEX `fk_tickets_user_id_foreign_idx` (`user_id` ASC) VISIBLE,
                    ADD INDEX `fk_tickets_priorite_id_foreign_idx` (`priorite_id` ASC) VISIBLE,
                    ADD INDEX `fk_tickets_categorie_id_foreign_idx` (`categorie_id` ASC) VISIBLE");
        ...
        DB::statement("ALTER TABLE `traitements` 
                    ...
                    CHANGE COLUMN `user_id` `user_id` INT(10) UNSIGNED NOT NULL ,
                    ADD INDEX `fk_traitements_user_id_foreign_idx` (`user_id` ASC) VISIBLE,
                    ADD INDEX `fk_traitements_ticket_id_foreign_idx` (`ticket_id` ASC) VISIBLE");
        DB::statement("ALTER TABLE `traitements` 
